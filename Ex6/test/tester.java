...
public class tester {
    ...
    private static final String TEST_DIR_PATH = "/Users/michael/IdeaProjects/Ex6/test";

    public static void main(String[] args) throws Exception {

        File tests_dir = new File(TEST_DIR_PATH + "/test_files");
        ...
        for (File test : test_files) {
            try {
                if(test.getAbsolutePath().equals("/Users/michael/IdeaProjects/Ex6/test/test_files/test504.sjava")){
                    int x=1;
                }
