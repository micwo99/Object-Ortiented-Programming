...
public class Ex7Tester {
	...
	public static Collection<String[]> readTests() throws IOException  {
		...
		try {
			fileReader = new FileReader(new File("/Users/michael/IdeaProjects/Ex6/presubmission_sjavac_tests.txt"));
	...
	public void runTests() throws IOException {
		...
		String str = new String("/Users/michael/IdeaProjects/Ex6/tests/test"+numOfTest+".sjava");
		String[] args = {str};
